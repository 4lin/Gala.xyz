...
<table width="100%">
	<tr>
		<td class="k" colspan="3">
			<img src="{$dpath}gebaeude/209.png" class="pic" alt="">
		</td>
	...
	<tr>
		<td colspan=9>
			<span class="contentz"><input class="btn_blue" type="submit" value="{$LNG.tut_compleat}" onclick=""/></span>
		</td>
	</tr>
	{/if}
	<tr>
