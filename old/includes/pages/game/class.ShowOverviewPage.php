	...
	function show()
	{
		...
		{		
			...
			if (!empty($CPLANET['b_building']) && $CPLANET['b_building'] > TIMESTAMP) {
				...
				$BuildPlanet		= "<span class=\"icon12px icon_wrench tooltip\" data-tooltip-content=\"".$LNG['tech'][$Queue[0][0]]."(".$Queue[0][1].")"."\" style=\"position:relative;top:17px;left:28px\"></span>"; /*&nbsp;(".pretty_time($Queue[0][3] - TIMESTAMP).") <a class=\"constructionIcon\" href=\"#\" title=\"\"><span class=\"icon12px icon_wrench\"></span></a>*/
			} else {
				$BuildPlanet     = "";
			}
