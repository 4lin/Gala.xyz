 ...
 * @info $Id: INSTALL.php 2579 2013-01-13 22:06:25Z slaver7 $
...
$LNG['intro_welcome']			= 'Herzlich Willkommen beim GALAXYZ!';
$LNG['intro_text']				= 'GALAXYZ ist eines der besten Klone von OGame.<br>GALAXYZ ist die neueste und stabilste XNova Version je entwickelt wurde. GALAXYZ glänzt durch Stabilität, Flexibilität, Dynamik, Qualität und Benutzerfreundlichkeit. Wir hoffen immer besser zu sein als ihre Erwartungen.<br><br>Das Installations-System führt Sie durch die Installation, oder Upgrade auf einer vorherigen Version auf die neueste ein. Jede Frage, ein Problem zögern Sie bitte nicht, unsere Entwicklung und Unterstützung zu ersuchen.<br><br>GALAXYZ ist ein OpenSource-Projekt und ist under GNU GPL v3 lizenziert. Zur Lizenz klicken Sie bitte im Menu auf die entsprechenden Menüpunkt.<br><br>Bevor die Installation gestartet werden kann, wird vorher ein kleiner Test durchgeführt, ob sie die Mindestanforderungen unterstützen.';
$LNG['intro_upgrade_head']		= 'GALAXYZ schon installiert?';
$LNG['intro_upgrade_text']		= '<p>Du hast GALAXYZ bereits installiert und möchtest einfach updaten?</p><p>Hier kann du deine alte Datenbank mit wenigen klicks aktualisieren!</p>';
...
$LNG['upgrade_required_rev']	= 'Der Updater kann nur ab Revision r2579 (GALAXYZ v1.7) oder höher updaten.';
...
$LNG['req_desc']				= 'Bevor die Installation fortgesetzt werden kann, wird GALAXYZ einige Tests zu deiner Server-Konfiguration und deinen Dateien durchführen, um sicherzustellen, dass du GALAXYZ installieren und benutzen kannst. Bitte lies die Ergebnisse aufmerksam durch und fahre nicht weiter fort, bevor alle erforderlichen Tests bestanden sind. Falls du irgendeine der Funktionen, die unter den optionalen Modulen aufgeführt sind, nutzen möchtest, solltest du sicherstellen, dass die entsprechenden Tests auch bestanden werden.';
$LNG['reg_yes']					= 'Ja';
$LNG['reg_no']					= 'Nein';
...
$LNG['reg_pdo_active']			= 'Ja';
$LNG['reg_pdo_desc']			= 'Pdo desc...(must update lang)';
$LNG['req_php_need']			= 'Installierte Version der Skriptsprache &raquo;PHP&laquo;';
$LNG['req_php_need_desc']		= '<strong>Voraussetzung</strong> — PHP ist die Serverseitige Sprache, in der GALAXYZ geschrieben ist. Damit GALAXYZ ohne Einschränkungen funktioniert, wird die PHP Version 5.2.5 vorrausgesetzt.';
...
$LNG['reg_global_desc']			= 'GALAXYZ wird auch funktionieren, wenn diese Einstellung aktiviert ist. Allerdings wird aus Sicherheitsgründen empfohlen, register_globals in der PHP-Installation zu deaktivieren, falls dies möglich ist.';
$LNG['req_ftp_head']			= 'Eingabe der Zugangsdaten für FTP';
$LNG['req_ftp_desc']			= 'Geben Sie Ihre FTP Daten ein, damit GALAXYZ automatisch die Probleme beheben kann. Alternativ können Sie auch manuell die Schreibrechte vergeben.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'Benutzername';
$LNG['req_ftp_password']		= 'Kennwort';
$LNG['req_ftp_dir']				= 'Installationspfad zu GALAXYZ';
...
$LNG['step1_desc']				= 'Nachdem nun festgestellt wurde, dass GALAXYZ auf deinem Server betrieben werden kann, musst du noch einige Informationen angeben. Wenn du nicht weißt, wie die Verbindungsdaten für deine Datenbank lauten, kontaktiere bitte als erstes deinen Webhosting-Provider oder wende dich an die GALAXYZ Support-Foren. Wenn du Daten eingibst, prüfe diese bitte sorgfältig, bevor du fortfährst.';
...
$LNG['step3_desc']				= 'Die von GALAXYZ genutzten Datenbank-Tabellen wurden nun erstellt und mit einigen Ausgangswerten gefüllt. Geh weiter zum nächsten Schritt, um die Installation von GALAXYZ abzuschließen.';
...
$LNG['step6_desc']				= 'Du hast GALAXYZ erfolgreich installiert.';
$LNG['step6_info_head']			= 'Starte mit GALAXYZ durch!';
...
$LNG['step8_need_fields']		= '(lang must be updated, line:129)';

$LNG['sql_close_reason']		= 'Game ist zurzeit geschlossen';
$LNG['sql_welcome']				= 'Herzlich Willkommen zu GALAXYZ v';
