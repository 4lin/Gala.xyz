...
// GALAXYZ - Copyright (C) 2010-2012 Slaver
...
$LNG['upgrade_required_rev']	= 'The Updater can work only from revision r2579 (GALAXYZ v1. 7) or later.';
...
$LNG['licence_accept']			= 'To continue the installation of GALAXYZ, you need to agree to the terms and conditions of lincense of GALAXYZ';
...
$LNG['req_desc']				= 'Before the installation proceed, GALAXYZ will be some tests to verify that your server supports the GALAXYZ, so ensure that the GALAXYZ can be installed. Its suggested that you read carefully the results, and do not proceed until all these be checked.';
$LNG['reg_yes']					= 'Yes';
$LNG['reg_no']					= 'No';
$LNG['reg_found']				= 'Found';
...
$LNG['req_php_need_desc']		= '<strong>Required</strong> — PHP is the language code base of GALAXYZ. This is the required PHP version 5.2.5 or higher so that all modules work correctly';
...
$LNG['reg_global_desc']			= 'GALAXYZ will also work, if this configuration is installed on your server. However, it is recommended for security reasons, disable "register_globals" in PHP installation, if that is possible.';
$LNG['req_ftp_head']			= 'Insert information of FTP';
$LNG['req_ftp_desc']			= 'Write your information from FTP so GALAXYZ automatically fix problems. Alternatively, you can also manually assign permissions to write.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'User name';
$LNG['req_ftp_password']		= 'Password';
$LNG['req_ftp_dir']				= 'Directory of GALAXYZ';
...
$LNG['step3_desc']				= 'The tables needed for the GALAXYZ database already have been created and populated with default values. To go to the next step, conclude the installation of GALAXYZ';
