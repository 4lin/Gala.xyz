...
<p>The moon can be done depends on the number of Destruction € that are made.The greatest chance of creating a simple moon is hunting the 1667 in Light that creates a chance for 20% of the moon. Usas hunt the Cars because they are easy to be destroyed.</p><p>Otherwise, for which there is chance of moon, need to have defenses on the planet. It is recommended to build 3334 Lance missile or Light Lasers adores</p><p>The huge amounts that will be made of Destruction, will determine the training of moon around your planet</p><p>Probability Moon between 1% and 19% is of random size and probability of 20% the moon will have 8000 MILES in diameter<br>Regular moons are never exceeding 8944 km in diameter.</p>
<h3>Construction</h3>
<p>The buildings can be Warehouses, tank of Deuterium, manufactures of Robots or Nanites, Hangar, deposit of Alliance, Moonbase, Sensor Phalanx and the Portal. The Hangar is useless to be built if the transfer to Planet Moon ships. The deposit of Alliance will be useful for defending the Moon attacks<br>The three specific buildings on the moon are:</p>
