...
// GALAXYZ - Copyright (C) 2012  Jan Kröpke
...
$LNG['intro_welcome']			= 'Olá utilizador de GALAXYZ!';
$LNG['intro_text']				= 'O GALAXYZ é um dos melhores projectos de OGame.<br>O GALAXYZ é a versão mais recente e mais estável do XNova actualmente desenvolvido. GALAXYZ é notável por sua facilidade de estabilidade, flexibilidade, dinamismo, qualidade e utilização. Nós sempre esperamos ser melhor do que as tuas expectativas.<br><br>O sistema de instalação irá guiar-te através da instalação ou atualizar de uma versão anterior para a mais recente. Cada questão, um problema, por favor não hesites em pedir ao nosso desenvolvimento e suporte em caso de duvidas!<br><br>O GALAXYZ é um projeto em Open Source, lincenciado sob GNU GPL v3. Para que esta seja verificado, por favor clica no link acima onde se refera a "Lincença"<br><br>Antes da instalação pode ser iniciado um pequeno teste para verificar se o teu Plano/Dominio tem todos os requesitos para suportar o GALAXYZ';
$LNG['intro_upgrade_head']		= 'GALAXYZ já instalado?';
$LNG['intro_upgrade_text']		= '<p>Já instalaste o GALAXYZ e queres fácil actualização?</p><p>Aqui podes atualizar a base de dados antiga com apenas alguns cliques!</p>';
...
$LNG['upgrade_required_rev']	= 'A atualizaçao apenas funciona na revisão 2579 (GALAXYZ v1.7) ou superior.';
...
$LNG['licence_accept']			= 'Para prosseguires a instalação de GALAXYZ, precisas de concordar com os Termos e Condições da Lincença do GALAXYZ';
...
$LNG['req_desc']				= 'Antes da instalação prosseguir, o GALAXYZ realizará alguns testes para verificar se o teu Servidor suporta o GALAXYZ, de modo garantir que o GALAXYZ possa ser instalado. É surgerido que leia cuidadosamente os resultados, e não prossiga até todos estes serem verificados.';
$LNG['reg_yes']					= 'Sim';
$LNG['reg_no']					= 'Não';
...
$LNG['req_php_need_desc']		= '<strong>Requerido</strong> — O PHP é a linguagem base de código do GALAXYZ. Este é requerido a versão PHP 5.2.5 ou superior para que todos os modulos funcionam correctamente';
...
$LNG['reg_global_desc']			= 'GALAXYZ também irá funcionar, se essa configuração está instalada no teu servidor. No entanto, é recomendado por razões de segurança, desactivar o "register_globals" na instalação PHP, se isso é possível.';
$LNG['req_ftp_head']			= 'Inserir informações de FTP';
$LNG['req_ftp_desc']			= 'Escreve as tuas informações de FTP de modo GALAXYZ poder corrigir automaticamente os problemas. Alternativamente, podes também atribuir manualmente permissões de gravação.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'Nome de Utilizador';
$LNG['req_ftp_password']		= 'Password';
$LNG['req_ftp_dir']				= 'Directória do GALAXYZ';
...
$LNG['step1_desc']				= 'Agora que foi determinado que GALAXYZ pode ser instalado no teu servidor, deverás fornecer algumas informações. Se tu não sabes como executar uma ligação de base de dados, entra em contato com teu provedor de hospedagem primeiro ou com o fórum de GALAXYZ para ajuda e suporte. Quando tu inserires os dados, verifica se foram introduzidos correctamente';
...
$LNG['step3_desc']				= 'As tabelas necessárias para a base de dados do GALAXYZ já foram criadas e preenchidas com os valores por defeito. Ao ires para o próximo passo, concluirás a instalação do GALAXYZ';
...
$LNG['step6_desc']				= 'Instalaste com sucesso o sistema GALAXYZ';
$LNG['step6_info_head']			= 'Começe a utilizar o GALAXYZ agora!';
$LNG['step6_info_additional']	= 'Se clicares no botão abaixo, serás redireccionado para a página de Administração. Ai será um bom partido para começares a explorar as ferramentas de Administrador de GALAXYZ.<br/><br/><strong>Por favor apaga o &raquo;includes/ENABLE_INSTALL_TOOL&laquo; ou modifica o nome do ficheiro. Com a existência deste ficheiro, pode causar o teu jogo em risco, ao permitir que alguem reescreva a instalação!</strong>';

$LNG['sql_close_reason']		= 'O jogo encontra-se fechado';
$LNG['sql_welcome']				= 'Bem vindo ao GALAXYZ v';
