 ...
 * @copyright 2012 Jan Kröpke <info@GALAXYZ.cc>
...
$LNG['intro_welcome'] = 'Bienvenido a GALAXYZ!';
$LNG['intro_text'] = 'GALAXYZ es uno de los mejores clones de OGame. <br> GALAXYZ es la última y más estable versión de un servidor basado en Xnova que ah sido desarrollada. Los puntos clave de GALAXYZ son su facilidad, estabilidad, flexibilidad, dinamismo y calidad. En GALAXYZ siempre esperamos a ser más que sus expectativas. <br> El sistema de instalación le guiará a través de la instalación o la actualización de una versión previa a la última. <br>  Si tiene preguntas o problemas, por favor, no dude en comunicarse en nuestro foro de desarrollo y soporte. <br> GALAXYZ es un proyecto de código abierto y está bajo licencia GNU GPL v3. Para conocer la licencia, por favor haga click en la opción del menú correspondiente. <br> Antes de comenzar la instalación se lleva a cabo una prueba para saber si el servidor cumple los requisitos mínimos.';
$LNG['intro_upgrade_head']		= 'GALAXYZ ya instalado?';
$LNG['intro_upgrade_text']		= '<p>GALAXYZ ya está instalado y sólo desea actualizarlo?</p>Aquí usted puede actualizar su base de datos antigua con unos pocos clics</p>';
...
$LNG['upgrade_required_rev']	= 'La actualización sólo se puede utilizar desde la r2579 (GALAXYZ v1.7) o superior.';
...
$LNG['req_desc']				= 'Antes de que la instalación pueda continuar, GALAXYZ realizará algunas pruebas en la configuración de su servidor y los archivos para asegurarse de que se puede instalar y utilizar GALAXYZ. Por favor, lea cuidadosamente los resultados y no van más allá de todas las pruebas necesarias hasta que haya sido aprobada. Si desea utilizar cualquiera de las funciones que se enumeran en los módulos opcionales, debe asegurarse de que las pruebas adecuadas también se pasan.';
$LNG['reg_yes'] = 'Sí';
$LNG['reg_no'] = 'No';
...
$LNG['reg_global_desc']			= 'GALAXYZ también trabajará, si esta opción está habilitada. Sin embargo, se recomienda por razones de seguridad, deshabilitar register_globals en la instalación de PHP, si es posible.';
$LNG['req_php_need'] = 'Versión PHP (min. 5.2.5)';
$LNG['req_php_need_desc']		= '<strong>Requisitos Previos</strong> — PHP es el lenguaje del lado del servidor, GALAXYZ está escrito en el. GALAXYZ Esto funciona sin ninguna limitación, la versión PHP 5.2.5 previsto.';

$LNG['req_ftp_head']			= 'Introduzca las credenciales de FTP';
$LNG['req_ftp_desc']			= 'Ingrese su información de FTP para que GALAXYZ pueda corregir automáticamente los problemas. Alternativamente, también puede asignar manualmente permisos de escritura.';
$LNG['req_ftp_host'] = 'Host FTP';
$LNG['req_ftp_username'] = 'Usuario';
$LNG['req_ftp_password'] = 'Contraseña';
$LNG['req_ftp_dir'] = 'Directorio de GALAXYZ';
...
$LNG['step1_desc']				= 'Ahora que se ha determinado que GALAXYZ se puede utilizar en su servidor, debe proporcionar cierta información. Si usted no sabe cómo los datos están conectados a la base de datos, por favor póngase en contacto con su proveedor de hosting, como la primera o la espalda en los foros de soporte de GALAXYZ. Al introducir datos, por favor revise esto cuidadosamente antes de continuar.';
...
$LNG['step3_desc']				= 'La base de datos utilizado por las tablas GALAXYZ se han creado y rellenado con unos valores iniciales. Ir al siguiente paso para completar la instalación de GALAXYZ.';
...
$LNG['step6_desc']				= 'Usted ha instalado exitosamente GALAXYZ.';
$LNG['step6_info_head']			= 'Comience con GALAXYZ!';
