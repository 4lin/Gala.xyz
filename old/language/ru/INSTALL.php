...
// GALAXYZ - Copyright © 2012 Jan Kröpke <info@GALAXYZ.cc>
...
$LNG['intro_welcome']         = 'Добро пожаловать в GALAXYZ!';
$LNG['intro_text']            = 'GALAXYZ - один из лучших клонов OGame.<br>GALAXYZ является самым стабильным и развивающимся движком из всех подобных XNova на данный момент. Мы надеемся, что GALAXYZ будет лучше, чем Вы ожидаете.<br><br>Если у Вас будут вопросы, консультируйтесь с нами.<br><br>GALAXYZ является проектом с открытым кодом и распространяется под лицензией GNU GPL v3, ознакомиться с которой Вы можете в разделе Лицензия.<br><br>Перед установкой будет запущен небольшой тест на соответствие минимальным требованиям.';
$LNG['intro_upgrade_head']    = 'GALAXYZ уже установлена';
$LNG['intro_upgrade_text']    = '<p>Вы уже установили GALAXYZ и просто хотите её обновить?</p><p>Здесь вы можете обновить старую базу данных с помощью нескольких кликов.</p>';
...
$LNG['upgrade_required_rev']  = 'Мастер обновления базы данных доступен с ревизии r2579 (GALAXYZ v1.7).';
...
$LNG['req_desc']              = 'Перед продолжением установки GALAXYZ выполнит проверку файлов конфигурации Вашего сервера на соответствие необходимым требованиям использования GALAXYZ. Пожалуйста, прочитайте внимательно результаты и не продолжайте установку, пока проверка не будет пройдена по всем пунктам. Если Вы хотите использовать любую из функций перечисленных ниже модулей, Вы должны убедиться, что проверка пройдена.';
$LNG['reg_yes']               = 'Да';
$LNG['reg_no']                = 'Нет';
$LNG['reg_found']             = 'Да';
...
$LNG['req_php_need_desc']     = '<strong>Необходимо</strong> — PHP является серверным языком, на котором написана игра. GALAXYZ работает без ограничений, используя версию PHP 5.2.5 и выше.';
...
$LNG['reg_global_desc']       = 'GALAXYZ будет корректно работать, если этот параметр включён. Тем не менее, рекомендуется по соображениям безопасности, отключить register_globals в настройках PHP.';
...
$LNG['req_ftp_dir']           = 'FTP путь к GALAXYZ';
...
$LNG['step1_desc']            = 'GALAXYZ может быть установлена на Вашем сервере, но Вы должны указать настройки доступа к базе данных. Если Вы не знаете настройки доступа для подключения к базе данных, узнайте их у Вашего хостинг-провайдера или связитесь с технической поддержкой GALAXYZ для консультации. При вводе данных, пожалуйста, проверьте их внимательно, прежде чем продолжить.';
...
$LNG['step3_desc']            = 'Таблицы базы данных созданы и заполнены. Переходите к следующему шагу, чтобы завершить установку GALAXYZ.';
...
$LNG['step6_desc']            = 'Вы установили GALAXYZ.';
$LNG['step6_info_head']       = 'Начните использовать GALAXYZ.';
...
$LNG['sql_welcome']           = 'Добро пожаловать в GALAXYZ v';