...
$LNG['req_php_need_desc']     = '<strong>Требование</strong> — PHP является серверным языком, на котором написана игра. 2Moons работает без ограничений, используя версию PHP 5.2.5 и выше.';
